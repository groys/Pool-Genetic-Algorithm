...
float GAThread::rndreal(float lo ,float hi)
/* real random number between specified limits */
{
    return((randomperc() * (hi - lo)) + lo);
}

void GAThread::warmup_random(float random_seed)
